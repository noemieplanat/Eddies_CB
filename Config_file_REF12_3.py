...
Config  = {'suffixe_all':'REF12_3',
           'L_depth_index':np.arange(0,75), 
            ...
            'Gridf':'/home/nplanat/projects/ctb-cdufour/nplanat/CREG_mask_modifs/Grid_f.nc',
            'prefixe_data': 'CREG12.L75-REF12_y',
            ...
            'tracking_formated_prefixe':'Formatted/1995_2020',
            'prefixe_monthy_means':'Monthly/M_',
            'prefixe_monthyP_means':'Monthly/P2_',
            'prefixe_monthly_climato':'Monthly/C_',
            'prefixe_monthlyP_climato':'Monthly/CP2_',
            'prefixe_properties_m' : 'Prop/Prop_TS_',
            'prefixe_properties_tracking':'Prop_Tracked/Tracked_CREG_1d_1995_2020_',
           ...
           'detection_parameters':{'model': Model['model'],
            ...
            'properties_parameters':{'fact':3, 
                                    'Properties_extract' : ['votemper_m', 'vosaline_m',\
                                                            'votemper_std_e', 'vosaline_std_e', \
                                                            'votemper_c','votemper_e', 
                                                            'vosaline_c','vosaline_e',\
                                                            ]},
